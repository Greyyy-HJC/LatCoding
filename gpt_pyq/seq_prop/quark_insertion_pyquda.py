...
from pyquda_utils import source, core, io, gamma
...
src_seq_pyq_down = down_quark_insertion_pyquda(propag, Cg5, PpSzp)
print(np.shape(src_seq_pyq_down.data))
print(np.linalg.norm(src_seq_pyq_down.data)**2)

src_seq_gpt_up = up_quark_insertion_pyquda(propag, propag, Cg5, PpSzp)
print(np.shape(src_seq_gpt_up.data))
print(np.linalg.norm(src_seq_gpt_up.data)**2)